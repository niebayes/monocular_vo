#ifndef MONO_SLAM_GEOMETRY_SOLVER_POINT_TO_EPIPOLAR_LINE_DISTANCE_H_
#define MONO_SLAM_GEOMETRY_SOLVER_POINT_TO_EPIPOLAR_LINE_DISTANCE_H_
...
#endif  // MONO_SLAM_GEOMETRY_SOLVER_POINT_TO_EPIPOLAR_LINE_DISTANCE_H_